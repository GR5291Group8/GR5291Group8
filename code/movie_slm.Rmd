...
# conduct multi-hot encoding to "month"
...
# cannot use conditional number?
# maybe should convert "month" to multi-hot coding format.
```
...
#  L11 + L15 + L33 + L44 + L45 + L51
language_reference_table[c(11, 15, 33, 44, 45, 51), ]
lmod_step_pop = lm(return_rate~runtime + vote_average + vote_count + year + Documentary +  Crime + Western + Mystery + Action + Science.Fiction + Fantasy + 
Animation + Horror + L11 + L15 + L33 + L44 + L45 + L51, data = data_return)
summary(lmod_step_pop)
```
5. Diagnostics
```{r}
# linearity
